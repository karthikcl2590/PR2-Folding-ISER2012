...
class SearchState():
    ...
    def makeChildren(self):
        ...
        for action in actions_move[self.robotPosition]:
            ...
            self.children.append(SearchState(polys = self.get_polys(),robotPosition=newPosition,g=self.get_g()+move_cost,actionToHere = ("move",action),parent = self, depth = self.get_depth()+1,availableFolds = list(self.availableFolds),completedFolds= list(self.completedFolds), dragHistory = list(self.dragHistory)))
